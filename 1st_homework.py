...
# """
#
# s_all = int(input('Какое количество журавликов сделали Петя, Катя и Сережа вместе?: '))
# s_katya = int(s_all / 3 * 2)
# s_petya_or_serezha = int(s_all / 6)
# print(f'Катя сделала {s_katya} журавликов, а Петя и Сережа - по {s_petya_or_serezha} журавликов')
...
# if int(part) <= int(size) and (int(part) % int(length) == 0 or int(part) % int(width) == 0):
#     print('Можно')
# else:
#     print('Нельзя')
